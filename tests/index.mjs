...
export default [ccFreshness, ccParse, ageParse, expires, expiresParse, ccResponse, heuristic, statuses, ccRequest, pragma, vary, conditional, headers, update304, invalidation, partial, other]
